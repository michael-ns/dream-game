...
React.renderComponent(
  Menu(), document.getElementById('board')
);
},{"./components/menu":149,"react":148}],2:[function(require,module,exports){
...
var Menu = React.createClass({displayName: 'Menu',
  ...
  render: function() {
    var level = levelList.levelList.map(function(level){
      return React.createElement("option", {value: level}, level)
    });

    return (
      React.createElement("div", {className: "menu"}, 
        React.createElement("select", {className: "level-dropdown"}, 
          level
        )
      )
    )
...
// );
},{"../../map/level-list.json":150,"react":148}],150:[function(require,module,exports){
module.exports={
  "levelList": [
    "level-1",
    "level-2",
